<?php $__env->startSection('title', 'Galeri - Identik Cafe'); ?>
            ...
            <div class="gallery-item group relative overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 lg:col-span-2">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-8">
                    <div>
                        ...
                        <a href="<?php echo e(route('contact')); ?>" class="bg-amber-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-amber-700 transition-all duration-300">Kunjungi Sekarang</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cafe-aroma\resources\views/website/gallery.blade.php ENDPATH**/ ?>