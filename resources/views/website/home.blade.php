@extends('layouts.app')
@section('title', 'Beranda - Identik Cafe')
    ...
    <div class="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        <div class="lg:w-1/2 text-center lg:text-left">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <a href="{{ route('menu') }}" class="bg-transparent border-2 border-amber-700 text-black-700 px-8 py-4 rounded-full font-semibold hover:bg-green-700 hover:text-white transition-all duration-300">Lihat Menu</a>
                <a href="{{ route('contact') }}" class="bg-transparent border-2 border-amber-700 text-amber-700 px-8 py-4 rounded-full font-semibold hover:bg-amber-700 hover:text-white transition-all duration-300">Hubungi Kami</a>
            </div>
        </div>
        <div class="lg:w-1/2">
...
<section class="py-20 bg-gradient-to-br from-amber-50 to-orange-50">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="text-center mt-12">
            <a href="{{ route('menu') }}" class="cta-button text-lg px-10 py-4">Lihat Semua Menu</a>
        </div>
    </div>
</section>
@endsection
