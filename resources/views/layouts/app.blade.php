...
<head>
    ...
    <title>@yield('title', 'Identik Cafe - Premium Dining')</title>
...
<body class="overflow-x-hidden">
    ...
    <nav class="navbar fixed top-0 w-full z-50 py-4 shadow-2xl">
        <div class="max-w-7xl mx-auto px-6 flex justify-between items-center">
            <a href="{{ route('home') }}" class="text-3xl font-bold bg-gradient-to-r from-yellow-400 to-orange-400 bg-clip-text text-transparent">
                Identik Cafe
            </a>
            <ul class="hidden lg:flex space-x-12">
                <li><a href="{{ route('home') }}" class="{{ request()->routeIs('home') ? 'text-yellow-400 font-semibold' : 'text-gray-300 hover:text-yellow-400' }} text-lg font-medium transition-all duration-300">Beranda</a></li>
                <li><a href="{{ route('menu') }}" class="{{ request()->routeIs('menu') ? 'text-yellow-400 font-semibold' : 'text-gray-300 hover:text-yellow-400' }} text-lg font-medium transition-all duration-300">Menu</a></li>
                <li><a href="{{ route('gallery') }}" class="{{ request()->routeIs('gallery') ? 'text-yellow-400 font-semibold' : 'text-gray-300 hover:text-yellow-400' }} text-lg font-medium transition-all duration-300">Galeri</a></li>
                <li><a href="{{ route('about') }}" class="{{ request()->routeIs('about') ? 'text-yellow-400 font-semibold' : 'text-gray-300 hover:text-yellow-400' }} text-lg font-medium transition-all duration-300">Tentang</a></li>
                <li><a href="{{ route('contact') }}" class="{{ request()->routeIs('contact') ? 'text-yellow-400 font-semibold' : 'text-gray-300 hover:text-yellow-400' }} text-lg font-medium transition-all duration-300">Kontak</a></li>
            </ul>
            <a href="{{ route('admin.contacts.index') }}" class="bg-gradient-to-r from-yellow-500 to-orange-500 text-black px-8 py-3 rounded-2xl font-bold text-lg hover:from-yellow-400 hover:to-orange-400 shadow-lg hover:shadow-gold/50 transition-all duration-300">
                Admin Panel
            </a>
        </div>
    </nav>
